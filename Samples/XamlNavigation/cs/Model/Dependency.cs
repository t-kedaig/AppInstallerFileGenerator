...
{
    [DataContract(Name = "Dependencies", Namespace ="")]
    public class Dependency
    {
        ...
        public Dependency(String filePath, String version, String publisher, String name, PackageType packageType, ProcessorArchitecture processorArchitecture)
        {
            _filePath = filePath;
            _version = version;
