...
{
    [DataContract(Name = "RelatedPackages", Namespace = "")]
    public class RelatedPackage
    {
        ...
        public RelatedPackage(String filePath, String version, String publisher, String name, PackageType packageType, ProcessorArchitecture processorArchitecture)
        {
            _filePath = filePath;
            _version = version;
