...
namespace AppInstallerFileGenerator.Views
{
	...
	public sealed partial class AppInstallerView : Page
	{
        ...
        {
            _filePath = AppInstallerFileGenerator.App.AppInstallerFilePath;
            _versionNumber = AppInstallerFileGenerator.App.AppInstallerVersionNumber;
        ...
        private void _save()
        {
            AppInstallerFileGenerator.App.AppInstallerFilePath = _filePath;
            AppInstallerFileGenerator.App.AppInstallerVersionNumber = _versionNumber;
        }
